...
<div class="max-w-2xl mx-auto">
    ...
    <!-- Form -->
    <form action="<?= url('company/services/store') ?>" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
            ...
            <div>
                ...
                <input type="text" name="icon" value="<?= old('icon', 'fas fa-star') ?>" placeholder="e.g., fas fa-laptop-code"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500">
            ...
            <div>
                ...
                <input type="text" name="price_range" value="<?= old('price_range') ?>" placeholder="e.g., $500 - $5,000"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500">
            </div>
